...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20250710151238_UpdateDbContextMigration1")]
    partial class UpdateDbContextMigration1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Orders.Orders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Orders.OrderItem", b =>
                {
                    b.HasOne("Core.Entities.Orders.Orders", null)
                        .WithMany("OrderItems")
